...
namespace MealsEnPlace.Api.Migrations
{
    ...
    [Migration("20260918021211_AddRecipeSearchTrigrams")]
    partial class AddRecipeSearchTrigrams
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MealsEnPlace.Api.Models.Entities.CanonicalIngredient", b =>
                {
                    ...
                    b.Property<int>("RecipeReferenceCount")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex(new[] { "Name" }, "IX_CanonicalIngredients_Name_Trgm");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex(new[] { "Name" }, "IX_CanonicalIngredients_Name_Trgm"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex(new[] { "Name" }, "IX_CanonicalIngredients_Name_Trgm"), new[] { "gin_trgm_ops" });
            ...
            modelBuilder.Entity("MealsEnPlace.Api.Models.Entities.CanonicalIngredientAlias", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CanonicalIngredientAliases");
                });
            ...
            modelBuilder.Entity("MealsEnPlace.Api.Models.Entities.ExternalTaskLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Provider", "ExternalProjectId");

                    b.HasIndex("Provider", "SourceType", "SourceScope");

                    b.HasIndex("SourceType", "SourceId", "Provider")
                        .IsUnique();

                    b.ToTable("ExternalTaskLinks");
                });
            ...
            modelBuilder.Entity("MealsEnPlace.Api.Models.Entities.Recipe", b =>
                {
                    ...
                    b.HasIndex(new[] { "Title" }, "IX_Recipes_Title_Trgm");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex(new[] { "Title" }, "IX_Recipes_Title_Trgm"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex(new[] { "Title" }, "IX_Recipes_Title_Trgm"), new[] { "gin_trgm_ops" });
