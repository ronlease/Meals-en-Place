...
namespace MealsEnPlace.Api.Migrations
{
    ...
    [Migration("20260419195843_RenameUnresolvedUomTokensTable")]
    partial class RenameUnresolvedUomTokensTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MealsEnPlace.Api.Models.Entities.CanonicalIngredient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Category = "Produce",
                            DefaultUomId = new Guid("a1000000-0000-0000-0000-000000000001"),
                            Name = "Apples"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("MealsEnPlace.Api.Models.Entities.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Abbreviation = "cup",
                            BaseUomId = new Guid("a1000000-0000-0000-0000-000000000003"),
                        ...
                        new
                        {
                            ...
                            Abbreviation = "kg",
                            BaseUomId = new Guid("a1000000-0000-0000-0000-000000000002"),
                            ConversionFactor = 1000.0m,
                            Name = "Kilogram",
                            UomType = "Weight"
                        },
            ...
            modelBuilder.Entity("MealsEnPlace.Api.Models.Entities.CanonicalIngredient", b =>
                {
                    b.HasOne("MealsEnPlace.Api.Models.Entities.UnitOfMeasure", "DefaultUom")
                        .WithMany()
            ...
            modelBuilder.Entity("MealsEnPlace.Api.Models.Entities.InventoryItem", b =>
                {
                    ...
                    b.HasOne("MealsEnPlace.Api.Models.Entities.UnitOfMeasure", "Uom")
                        .WithMany()
                        .HasForeignKey("UomId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("MealsEnPlace.Api.Models.Entities.UnitOfMeasure", b =>
                {
                    b.HasOne("MealsEnPlace.Api.Models.Entities.UnitOfMeasure", "BaseUom")
