...
export class PreferencesService {
  private readonly _autoDepleteOnConsume = signal<boolean>(false);
  ...
  readonly autoDepleteOnConsume = this._autoDepleteOnConsume.asReadonly();
  ...
  setAutoDepleteOnConsume(value: boolean): void {
